...
function descuento(banco,precioDesc){ //Calculo del precio de un producto en función de descuentos bancarios.
    switch (banco){
        ...
        case 3: precioDesc = precioDesc*0.85; //Descuento del 15%
...
let banco = Number(prompt("Ingresá el banco de la tarjeta a abonar. (Tenemos descuentos con Macro: 5% (1), BBVA: 10% (2) y con HBSC: 15% (3) )."))
